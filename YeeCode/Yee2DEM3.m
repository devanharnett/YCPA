...
for i = 1:nSteps
    ...
    for k = 1:Reg.n
        ...
        if bc{k}.NumS > 0
            ...
            Einc2 = bc{k}.s(2).fct(xC{k},i,t,bc{k}.s(2).paras);
            Eincp2 = bc{k}.s(2).fct(xC{k},i,t-ds/c_c/2,bc{k}.s(2).paras);
            
            Hx{k}(:,bc{k}.s(2).ypos) = Hx{k}(:,bc{k}.s(2).ypos) + dt/ds/c_mu_0*Einc2';
            Ez{k}(:,bc{k}.s(2).ypos-1) = Ez{k}(:,bc{k}.s(2).ypos-1) - dt/ds/c_eps_0/c_eta_0*Eincp2';
        end
